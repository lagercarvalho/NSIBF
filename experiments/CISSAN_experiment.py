...
from framework.preprocessing.data_loader import load_cissan_data
...
train_df,val_df,test_df,signals = load_cissan_data()
...
if retrain_model:
    ...
    kf.save_model('../results/CISSAN')
    print('optHPCfg',optHPCfg)
    print('bestScore',bestScore)
else:
    kf = kf.load_model('../results/CISSAN')
...
np.savetxt('../results/CISSAN/NSIBF_scores',z_scores)
